<template>
    <div class="shopping-cart-section">
        ...
        <div class="heading">
            <span>購物車</span>
            <h3>Good products, Best Quality</h3>
        </div>
            ...
            <div class="wrapper wrapper-content">
                <div class="row">
                    <div class="in-cart col-md-9">
                        <div class="box">
                            <div class="box-title item-total row">
                                <h3>
                                    <p style="font-size: 15px;">{{ filterFoods.length.toString() }}
                                        <span v-if="filterFoods.length < 2">物品</span>
                                        <span v-else>物品</span>
                                    </p>在購物車
                                </h3>
                            </div>
                            ...
                            <div v-if="!filterFoods.length">
                                <div class="box-content row no-food">
                                    <div class="content">
                                        <h2 style="color: #057835fa;">您的購物車中還沒有任何商品，請前往購物！</h2>
                                    </div>
                                    <div class="image">
                        ...
                        <div class="box-content row">
                            <router-link to="/menu" class="btn shop-btn"><i class="fa fa-arrow-left"></i>繼續購物</router-link>
                            <button class="btn check-out-btn" style="margin-left: 10px;"
                                :disabled="filterFoods.length ? false : true" @click="checkOutBtn()"><i
                                    class="fa fa fa-shopping-cart"></i>下一步</button>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="box">
                            ...
                            <div class="box-content text-center">
                                <h3><i class="fa fa-phone"></i> +886 0282093211</h3>
                                <span class="large">
                                    如果您有任何疑問，請與我們聯絡。
                                </span>
                            </div>
